! function(o) {
	...
	function r(t, i, a) {
		...
		return n.onerror = function(e) {
			...
			e && r.isInstanceOf("Blob", e) ? o = r.createObjectURL(t = e) : (o = t, a && a.crossOrigin && (n.crossOrigin = a.crossOrigin)),
				n.src = o
		}, a), n) : r.isInstanceOf("Blob", t) || r.isInstanceOf("File", t) ? (o = n._objectURL = r.createObjectURL(t)) ? (n.src =
			o, n) : r.readFile(t, function(e) {
			var t = e.target;
...
function(e) {
	"use strict";
	"function" == typeof define && define.amd ? define(["./load-image"], e) : "object" == typeof module && module.exports ?
		e(require("./load-image")) : e(window.loadImage)
}(function(I) {
	"use strict";
	var n = I.transform;
	I.transform = function(e, t, i, a, o) {
		...
		return i.crop = !0, r < (o = e.naturalWidth || e.width) / (n = e.naturalHeight || e.height) ? (i.maxWidth = n * r,
			i.maxHeight = n) : (i.maxWidth = o, i.maxHeight = o / r), i
		...
		if (h && (c = (t = I.getTransformedOptions(e, t, i)).left || 0, d = t.top || 0, t.sourceWidth ? (s = t.sourceWidth,
					void 0 !== t.right && void 0 === t.left && (c = m - s - t.right)) : s = m - c - (t.right || 0), t.sourceHeight ?
				(l = t.sourceHeight, void 0 !== t.bottom && void 0 === t.top && (d = b - l - t.bottom)) : l = b - d - (t.bottom ||
					0), y = s, S = l), a = t.maxWidth, o = t.maxHeight, n = t.minWidth, r = t.minHeight, h && a && o && t.crop ? (g =
				s / l - (y = a) / (S = o)) < 0 ? (l = o * s / a, void 0 === t.top && void 0 === t.bottom && (d = (b - l) / 2)) :
			0 < g && (s = a * l / o, void 0 === t.left && void 0 === t.right && (c = (m - s) / 2)) : ((t.contain || t.cover) &&
				(n = a = a || n, r = o = o || r), t.cover ? (v(), x()) : (x(), v())), h) {
			if (1 < (u = t.pixelRatio) && (p.style.width = y + "px", p.style.height = S + "px", y *= u, S *= u, p.getContext(
					"2d").scale(u, u)), 0 < (f = t.downsamplingRatio) && f < 1 && y < s && S < l)
				for (; y < s * f;) p.width = s * f, p.height = l * f, I.renderImageToCanvas(p, e, c, d, s, l, 0, 0, p.width, p.height),
					d = c = 0, s = p.width, l = p.height, (e = document.createElement("canvas")).width = s, e.height = l, I.renderImageToCanvas(
						e, p, 0, 0, s, l, 0, 0, s, l);
			return p.width = y, p.height = S, I.transformCoordinates(p, t), I.renderImageToCanvas(p, e, c, d, s, l, 0, 0, y, S)
		}
...
function(e) {
	...
	p.blobSlice = e && function() {
		...
		!!("undefined" != typeof DataView && e && 12 <= e.size && "image/jpeg" === e.type && p.blobSlice) && p.readFile(p.blobSlice
			.call(e, 0, t),
			function(e) {
				...
				if (65496 === r.getUint16(0)) {
					for (; s < l && (65504 <= (t = r.getUint16(s)) && t <= 65519 || 65534 === t);) {
						...
						c = s += i
					}!u.disableImageHead && 6 < c && (n.slice ? f.imageHead = n.slice(0, c) : f.imageHead = new Uint8Array(n).subarray(
						0, c))
...
function(e) {
	"use strict";
	"function" == typeof define && define.amd ? define(["./load-image", "./load-image-meta"], e) : "object" == typeof module &&
		module.exports ? e(require("./load-image"), require("./load-image-meta")) : e(window.loadImage)
}(function(o) {
	"use strict";
	"undefined" != typeof fetch && "undefined" != typeof Request ? o.fetchBlob = function(e, t, i) {
		o.hasMetaOption(i) ? fetch(new Request(e, i)).then(function(e) {
			return e.blob()
		}).then(t).catch(function(e) {
			console.log(e), t()
		}) : t()
	} : "undefined" != typeof XMLHttpRequest && "undefined" != typeof ProgressEvent && (o.fetchBlob = function(e, t, i) {
		if (o.hasMetaOption(i)) {
			i = i || {};
			var a = new XMLHttpRequest;
			a.open(i.method || "GET", e), i.headers && Object.keys(i.headers).forEach(function(e) {
				a.setRequestHeader(e, i.headers[e])
			}), a.withCredentials = "include" === i.credentials, a.responseType = "blob", a.onload = function() {
				t(a.response)
...
function(e) {
	"use strict";
	"function" == typeof define && define.amd ? define(["./load-image", "./load-image-scale", "./load-image-meta"], e) :
		"object" == typeof module && module.exports ? e(require("./load-image"), require("./load-image-scale"), require(
			"./load-image-meta")) : e(window.loadImage)
}(function(l) {
	"use strict";
	...
	l.hasCanvasOption = function(e) {
		...
		return 4 < a.orientation && (a.maxWidth = n.maxHeight, a.maxHeight = n.maxWidth, a.minWidth = n.minHeight, a.minHeight =
			n.minWidth, a.sourceWidth = n.sourceHeight, a.sourceHeight = n.sourceWidth), a
	}
}),
function(e) {
	"use strict";
	...
	g.ExifMap = function() {
		...
		if (!o.disableExif) {
			...
			if (1165519206 === e.getUint32(t + 4))
				...
				42 === e.getUint16(l + 2, n) ? (r = e.getUint32(l + 4, n), a.exif = new g.ExifMap, (r = g.parseExifTags(e, l, l +
					r, n, a)) && !o.disableExifThumbnail && (s = {
					exif: {}
				}, r = g.parseExifTags(e, l, l + r, n, s), s.exif[513] && (a.exif.Thumbnail = g.getExifThumbnail(e, l + s.exif[
					513], s.exif[514]))), a.exif[34665] && !o.disableExifSub && g.parseExifTags(e, l, l + a.exif[34665], n, a), a.exif[
					34853] && !o.disableExifGps && g.parseExifTags(e, l, l + a.exif[34853], n, a)) : console.log(
...
function(e) {
	"use strict";
	"function" == typeof define && define.amd ? define(["./load-image", "./load-image-exif"], e) : "object" == typeof module &&
		module.exports ? e(require("./load-image"), require("./load-image-exif")) : e(window.loadImage)
}(function(e) {
	"use strict";
	e.ExifMap.prototype.tags = {
			...
			switch (e) {
				...
				case "ComponentsConfiguration":
					if (!t) return;
					return this.stringValues[e][t[0]] + this.stringValues[e][t[1]] + this.stringValues[e][t[2]] + this.stringValues[e]
						[t[3]];
				case "GPSVersionID":
					if (!t) return;
...
function(e) {
	...
	u.IptcMap = function() {
		...
		for (var n, r, s, l = t; l < t + i;) 28 === e.getUint8(l) && 2 === e.getUint8(l + 1) && (s = e.getUint8(l + 2)) in
			a.iptc.tags && (r = e.getInt16(l + 3), n = o(e, l + 5, r), Object.prototype.hasOwnProperty.call(a.iptc, s) ? a.iptc[
				s] instanceof Array ? a.iptc[s].push(n) : a.iptc[s] = [a.iptc[s], n] : a.iptc[s] = n), l++
...
function(e) {
	"use strict";
	"function" == typeof define && define.amd ? define(["./load-image", "./load-image-iptc"], e) : "object" == typeof module &&
		module.exports ? e(require("./load-image"), require("./load-image-iptc")) : e(window.loadImage)
}(function(e) {
	"use strict";
